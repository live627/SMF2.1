...
function ManageSearchEngineSettings($return_config = false)
{
	...
	// Set up a message.
	$context['settings_message'] = '<span class="smalltext">' . sprintf($txt['spider_settings_desc'], $scripturl . '?action=admin;area=featuresettings;sa=pruning;sesc=' . $context['session_id']) . '</span>';
