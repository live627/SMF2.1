...
function template_menu()
{
	...
	echo \'
				...
				<a href="\', $scripturl, \'?action=help" class="extern">\', ($settings[\'use_image_buttons\'] ? \'<img src="\' . $settings[\'images_url\'] . \'/\' . $context[\'user\'][\'language\'] . \'/help.gif" alt="\' . $txt[\'help\'] . \'" border="0" />\' : $txt[\'help\']), \'</a>\', $context[\'menu_separator\'];
