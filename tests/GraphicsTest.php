...
class GraphicsTest extends BaseTestCase
{
	 ...
	 * @return (int|string)[][]
	 *
	 * @psalm-return array{0: array{url: string, width: int, height: int, format: int}, 1: array{url: string, width: int, height: int, format: int}, 2: array{url: string, width: int, height: int, format: int}, 3: array{url: string, width: int, height: int, format: int}}
	 */
