...
class BBCTest extends BaseTestCase
{
	 ...
	 * @return void
	 */
	public function testPreparseBBcode($test, $expected): void
	{
		global $sourcedir;
	 ...
	 * @return void
	 */
	public function testBBC($tag, $test, $expected): void
	{
	 ...
	 * @return void
	 */
	public function test_html_to_bbc($test, $expected): void
	{
	 ...
	 * @return void
	 */
	public function testSmiley($test, $expected): void
	{
		parsesmileys($test);
		$this->assertEquals($expected, $test);
	 ...
	 * @return void
	 */
	public function testLegacyBBC($tag, $test, $expected): void
	{
		preparsecode($test);
		$this->assertEquals($expected, $test);
