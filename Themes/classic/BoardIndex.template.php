...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="tborder"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>
	<tr>
		<td valign="middle" align="center" height="60px"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>';
