			...
			<div class="windowbg">
				...
				<div class="content">
					<ul class="reset">
						...
						<li>
							<a href="', $scripturl, '?action=admin;area=theme;th=', $context['theme_settings']['theme_id'], ';', $context['session_var'], '=', $context['session_id'], ';sa=edit;filename=css">', $txt['theme_edit_style'], '</a>
						</li>
					</ul>
				</div>
				<span class="botslice"><span></span></span>
			...
			<dl>
				...
				<dd>
					<ul class="reset">
						...
						<li><a href="' . $scripturl . '?action=admin;area=theme;th=' . $theme['id'] . ';' . $context['session_var'] . '=' . $context['session_id'] . ';sa=edit;filename=css">' . $txt['themeadmin_edit_style'] . '</a></li>' : '', '
