...
{
	// Simpler solutions work in Opera and Safari, but not in Firefox and IE (except sometimes!)
	...
	{
		// What else can we do? By the way, this doesn't work in IE, nor Mac's Safari.
