...
$txt['modlog_position'] = 'Posititie';
$txt['modlog_action'] = 'Actie';
$txt['modlog_ip'] = 'IP';
$txt['modlog_search_result'] = 'Zoekresultaten';
$txt['modlog_total_entries'] = 'Totalen';
// Untranslated!
$txt['modlog_ac_approved_topic'] = 'Approved Topic';
$txt['modlog_ac_approved'] = 'Approved';
$txt['modlog_ac_banned'] = 'Gebanned';
$txt['modlog_ac_locked'] = 'Op slot gezet';
$txt['modlog_ac_stickied'] = 'Sticky gemaakt';
$txt['modlog_ac_deleted'] = 'Verwijderd';
$txt['modlog_ac_deleted_member'] = 'Verwijderd lid';
$txt['modlog_ac_removed'] = 'Verwijderd';
$txt['modlog_ac_modified'] = 'Aangepast';
$txt['modlog_ac_merged'] = 'Samengevoegd';
$txt['modlog_ac_split'] = 'Afgesplitst';
$txt['modlog_ac_moved'] = 'Verplaatst';
$txt['modlog_ac_profile'] = 'Profiel bewerkt';
$txt['modlog_ac_pruned'] = 'board opgeschoond';
...
$txt['modlog_no_entries_found'] = 'Geen acties gevonden';
