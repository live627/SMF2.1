...
$txt['coppa_after_registration'] = 'Dank je voor je regstratie op {$forumname}.<br /><br />Als lid onder de leeftijd van {MINIMUM_AGE} jaar is er een wettelijke verplichting om de goedkeuring van ouders of voogd te krijgen voordat je gebruik mag maken van je account. Print onderstaand formulier uit om activering van je account te regelen:';
...
$txt['coppa_form_body'] = 'Ik {PARENT_NAME},<br /><br />geef toestemming aan {CHILD_NAME} (naam kind) om volwaardig geregistreerd lid te worden op het forum: {$forumname}, met de gebruikersnaam: {USER_NAME}.<br /><br />Ik begrijp dat bepaalde persoonlijke informatie door {USER_NAME} ingevuld getoond kan worden aan andere gebruikers van het forum.<br /><br />Getekend:<br />{PARENT_NAME} (Ouder/Voogd).';
