...
$txt['db_settings_server_info'] = 'Dit is meestal localhost - dus als je het niet weet, gebruik dan localhost.';
$txt['db_settings_username'] = 'Gebruikersnaam';
$txt['db_settings_username_info'] = 'Vul hier de gebruikersnaam in die je nodig hebt om een verbinding te maken met de database.<br />Als je de gebruikersnaam niet weet, gebruik die dan van je FTP account, deze zijn veelal gelijk aan elkaar.';
$txt['db_settings_password'] = 'Wachtwoord';
$txt['db_settings_password_info'] = 'Vul hier het wachtwoord in dat je nodig hebt om een verbinding te maken met je database.<br />Als je het wachtwoord niet weet, gebruik die dan van je FTP account, deze zijn veelal gelijk aan elkaar.';
$txt['db_settings_database'] = 'Databasenaam';
$txt['db_settings_database_info'] = 'Vul hier de naam in van de database waar je SMF de data in wilt laten zetten voor je forum.<br />Als de database niet bestaat, zal er worden geprobeerd deze aan te maken.';
$txt['db_settings_prefix'] = 'Tabel-prefix';
$txt['db_settings_prefix_info'] = 'Vul hier de prefix in die je voor iedere tabel in de database wilt hebben.  <b>Installeer niet twee forums met dezelfde prefix!</b><br />Deze prefix gebruik je om meerdere installaties mogelijk te maken in dezelfde database.';
...
$txt['error_db_database'] = 'Kan geen verbinding maken met de &quot;<i>%s</i>&quot; database.  Bij sommige hosts dien je een database te maken via een administratiepagina (cpanel / manager) voordat SMF het kan gebruiken.  Sommigen gebruiken ook prefixes - zoals je gebruikersnaam - bij de databasenaam.';
// Untranslated!
...
$txt['error_db_alter_priv'] = 'Het account dat je specificeerde, heeft geen permissie om tabellen te wijzigen (ALTER), aan te maken (CREATE) en/of te verwijderen (DROP); dit is noodzakelijk voor het juist functioneren van SMF.';
