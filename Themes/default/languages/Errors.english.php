...
$txt['filename_exisits'] = 'Sorry! There is already an attachment with the same filename as the one you tried to upload. Please rename the file and try again.';
...
$txt['restore_not_found'] = 'The following messages could not be restored as they were deleted on an earlier version of the forum software:<ul style="margin-top: 0px;">%1$s</ul>You will need to move these manually.';
