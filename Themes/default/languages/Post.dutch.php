...
$txt[253] = 'Vet';
$txt[254] = 'Schuin';
$txt[255] = 'Onderstrepen';
$txt[256] = 'Centreren';
$txt[257] = 'Voeg hyperlink toe';
$txt[258] = 'Voeg e-mail toe';
$txt[259] = 'Voeg code toe';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt[260] = 'Voeg citaat toe';
$txt[261] = 'Voeg lijst toe';
...
$txt[272] = 'Teal';
$txt[273] = 'Donkerblauw';
$txt[274] = 'Kastanjebruin';
$txt[275] = 'Lichtgroen';
$txt[276] = 'Smileys uitzetten';
$txt[277] = 'Gebruik geen smileys.';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt[280] = 'geplaatst op';
$txt[281] = 'Standaard';
$txt[282] = 'Duim omhoog';
$txt[283] = 'Duim omlaag';
$txt[284] = 'Uitroepteken';
$txt[285] = 'Vraagteken';
$txt[286] = 'Lampje';
$txt[297] = 'Voeg Smileys toe';
$txt[433] = 'Voeg Flash toe';
$txt[434] = 'Voeg FTP-link toe';
$txt[435] = 'Voeg Afbeelding toe';
$txt[436] = 'Voeg Tabel toe';
$txt[437] = 'Voeg Tabelkolom toe';
$txt[438] = 'Er zijn geen topics met notificatie!';
$txt[439] = 'Lichtkrant';
$txt[440] = 'Teletype';
$txt[441] = 'Doorhaling';
$txt[442] = 'Gloeiend';
...
$txt[445] = 'Links uitlijnen';
$txt[446] = 'Rechts uitlijnen';
$txt[447] = 'Bovenschrift';
$txt[448] = 'Onderschrift';
$txt[449] = 'Voeg Tabelrij toe';
$txt[499] = 'Je bericht is te lang. Maak het bericht wat korter en probeer het dan nogmaals.';
$txt[531] = 'Horizontale lijn';
$txt[532] = 'Letter formaat';
$txt[533] = 'Lettertype';
...
$txt['notify_boardsUnsubscribe'] = 'Notificaties voor nieuwe topics op dit board uitzetten door hier te klikken';

$txt['smf13'] = 'Afsluiten na bericht';
$txt['smf14'] = 'Breng me op de hoogte als er reacties zijn.';
$txt['smf15'] = 'Sluit dit topic.';
$txt['smf16'] = 'sneltoetsen: gebruik alt+s om te verzenden/posten of alt+p om een voorbeeld te bekijken';
$txt['smf22'] = 'Optie';
$txt['smf40'] = 'Reset het aantal stemmen';
$txt['smf41'] = 'Vink dit aan als je de resultaten op 0 wilt zetten.';
$txt['smf42'] = 'stemmen';
$txt['smf119'] = 'Bijlage';
$txt['smf119b'] = 'Bijgevoegd';
$txt['smf120'] = 'Toegestane extensies';
$txt['smf121'] = 'Maximale bestandsformaat toegestaan';
$txt['smf123'] = 'Je kunt een bestand met deze extensie niet uploaden. De enige toegestane extensies zijn';
$txt['smf129'] = 'Om je bijlage te verwijderen, laat je dit leeg.';
$txt['smf130'] = 'Vink de bijlagen die je niet langer toegevoegd wilt hebben uit.';
$txt['smf130b'] = 'Dat is een beschermde bestandsnaam.  Probeer een andere bestandsnaam.';
$txt['smf287'] = 'Waarschuwing: topic is op dit moment gesloten! Alleen moderators en administrators kunnen reageren.';
// Untranslated!
...
$txt['rtm3'] = 'Gemeld bericht';
$txt['rtm4'] = 'door';
$txt['rtm10'] = 'Verzenden';
// Use numeric entities in the below four strings.
$txt['rtm_email1'] = 'Het volgende bericht, "%s" van';
$txt['rtm_email2'] = 'is aan je gemeld door';
$txt['rtm_email3'] = 'op een board waarop jij moderator bent';
$txt['rtm_email_comment'] = 'Het lid heeft het volgende bericht er aan toegevoegd';

$txt['maxAttachPerPost'] = 'per bericht';

$txt['post_additionalopt'] = 'Extra opties...';
$txt['sticky_after2'] = 'Maak dit topic sticky.';
$txt['move_after2'] = 'Verplaats dit topic.';
$txt['back_to_topic'] = 'Terug naar dit topic.';
// Untranslated!
$txt['approve_this_post'] = 'Approve this Post';

$txt['retrieving_quote'] = 'Citaat ophalen...';

$txt['poll_options'] = 'Pollinstellingen';
$txt['poll_options1a'] = 'Activeer de poll voor ';
$txt['poll_options1b'] = 'dagen. (laat leeg voor onbeperkt)';
$txt['poll_options2'] = 'Laat iedereen de resultaten zien van deze poll.';
$txt['poll_options3'] = 'Laat de resultaten alleen zien nadat iemand heeft gestemd.';
$txt['poll_options4'] = 'laat de resultaten van de poll alleen zien nadat de stemperiode is afgelopen.';
$txt['poll_options5'] = 'Maximum aantal stemmen per gebruiker.';
$txt['poll_options7'] = 'Sta gebruiker toe om z\'n stem te wijzigen.';
$txt['poll_error1'] = 'je hebt teveel opties geselecteerd - toegestaan maximum is %s';
...
$txt['error_new_reply'] = 'Waarschuwing - terwijl je bezig was met reageren is er een nieuwe reactie geplaatst. Het zou kunnen dat je je reactie nog wilt aanpassen.';
$txt['error_new_replies'] = 'Waarschuwing - terwijl je bezig was met reageren zijn er %d nieuwe reacties geplaatst. Het zou kunnen dat je je reactie nog wilt aanpassen.';
$txt['error_new_reply_reading'] = 'Waarschuwing - terwijl je aan het lezen was is er een nieuwe reactie geplaatst. Het zou kunnen dat je je reactie nog wilt herzien.';
$txt['error_new_replies_reading'] = 'Waarschuwing - terwijl je aan het lezen was, zijn er %d nieuwe reacties geplaatst. Het zou kunnen dat je je reactie nog wilt herzien.';
$txt['error_old_topic'] = 'Waarschuwing: er zijn al zo\'n {$modSettings.oldTopicDays} dagen geen berichten meer geplaatst in dit topic.<br />Tenzij je zeker weet dat je hier wilt reageren, denk erover om een nieuw topic aan te maken.';
...
$txt['notification_new_topic_body'] = 'De tekst van het topic staat hieronder:';
