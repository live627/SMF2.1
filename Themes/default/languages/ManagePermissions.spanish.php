...
$txt['permissions_only_one_option'] = 'Puedes seleccionar solamente una acci&oacute;n para modificar los permisos';
$txt['permissions_no_action'] = 'No se seleccion&oacute; ninguna acci&oacute;n';
$txt['permissions_deny_dangerous'] = 'Est&aacute;s a punto de negar uno o m&aacute;s permisos.\\nEsto puede ser peligroso y causar resultados inesperados si \\"accidentalmente\\" dejaste a alguien en los grupos a los que les negar&aacute;s permisos.\\n\\n&#191;Est&#225;s seguro que deseas continuar?';
...
$txt['permissionhelp_pm_read'] = 'Este permiso le permite a los usuarios acceder a la secci&oacute;n de Mensajes Personales para leer sus mensajes. Si este permiso, un usuario no puede enviar mensajes personales.';
$txt['permissionname_pm_send'] = 'Enviar mensajes personales';
$txt['permissionhelp_pm_send'] = 'Env&iacute;a mensajes personales a otros usuarios registrados. Necesita del permiso Requires the \'Leer mensajes personales\'.';
...
$txt['permissionhelp_calendar_post'] = 'Un evento es un tema ligado a cierta fecha, o rango de fechas. Se puede hacer la creaci&oacute;n de eventos desde el calendario. Un evento puede crearse solamente si el usuario que crea el evento puede crear nuevos temas.';
$txt['permissionname_calendar_edit'] = 'Editar eventos en el calendario';
$txt['permissionhelp_calendar_edit'] = 'Un evento es un tema ligado a cierta fecha, o rango de fechas. Los eventos pueden ser editados al hacer click en el asterisco rojo (*) al lado del evento, en la vista del calendario. Para poder modificar un evento, el usuario debe tener los permisos necesarios para editar el primer mensaje del tema que est&aacute; ligado al evento.';
...
$txt['permissionhelp_moderate_forum'] = 'Este permiso incluye todas las funciones importantes de moderaci&oacute;n de usuarios, tales como la prohibir el acceso, manejo del registro de usuarios, rastreo de usuarios.';
...
$txt['permissionhelp_profile_view'] = 'Este permiso le permite a los usuarios hacer click en un nombre de usuario para ver un resumen de la configuraci&oacute;n de su perfil, algunas estad&iacute;sticas, y todos los mensajes del usuario.';
...
$txt['permissionhelp_report_any'] = 'Este permiso agrega una liga a cada mensaje, permitiendole a un usuario reportar el mensaje al moderador. Al reportarlo, todos los moderadores de ese foro recibir&aacute;n un email con una liga al mensaje reportado y una descripci&oacute;n del problema (proporcionado por el usuario que lo report&oacute;).';
