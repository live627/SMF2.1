...
$txt['whoall_.xml'] = 'Bekijkt een XML-feed.';
...
$txt['whotopic_editpoll'] = 'Wijzigt de poll bij &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot;.';
$txt['whotopic_mergetopics'] = 'Voegt topic &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot; samen met een ander onderwerp.';
$txt['whotopic_movetopic'] = 'Verplaatst topic &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot; naar een ander board.';
$txt['whotopic_post'] = 'Plaatst een bericht in <a href="' . $scripturl . '?topic=%d.0">%s</a>.';
$txt['whotopic_post2'] = 'Plaatst een bericht in <a href="' . $scripturl . '?topic=%d.0">%s</a>.';
$txt['whotopic_printpage'] = 'Print het topic &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot;.';
$txt['whotopic_sendtopic'] = 'Verstuurt het topic &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot; naar een vriend.';
$txt['whotopic_splittopics'] = 'Splitst het topic &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot; in twee topics.';
$txt['whotopic_vote'] = 'Stemt in <a href="' . $scripturl . '?topic=%d.0">%s</a>.';

$txt['whopost_quotefast'] = 'Citeert een bericht van &quot;<a href="' . $scripturl . '?topic=%d.0">%s</a>&quot;.';

$txt['whoadmin_detailedversion'] = 'Voert een gedetailleerde versiecheck uit.';
$txt['whoadmin_dumpdb'] = 'Maakt een backup van de database.';
$txt['whoadmin_editagreement'] = 'Wijzigt de registratieregels.';
$txt['whoadmin_featuresettings'] = 'Bewerkt forum features en instellingen.';
$txt['whoadmin_modlog'] = 'Bekijkt het moderatielog.';
$txt['whoadmin_serversettings'] = 'Wijzigt foruminstellingen.';
...
$txt['whoallow_admin'] = 'Bekijkt de <a href="' . $scripturl . '?action=admin">beheerpagina</a>.';
...
$txt['whoallow_setreserve'] = 'Wijzigt gereserveerde namen.';
$txt['whoallow_stats'] = 'Bekijkt de <a href="' . $scripturl . '?action=stats">forumstatistieken</a>.';
$txt['whoallow_viewErrorLog'] = 'Bekijkt de foutenlog.';
...
$txt['who_poll'] = 'Plaatst een nieuwe poll in <a href="' . $scripturl . '?board=%d.0">%s</a>.';
