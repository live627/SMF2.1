...
$txt['permissionname_view_stats'] = 'Bekijk de forum statistieken';
$txt['permissionhelp_view_stats'] = 'De forum statistieken geven alle statistieken van het forum, zoals aantal leden, aantal berichten per dag, en verscheidene top 10 statistieken. Deze permissie toestaan laat een link verschijnen onder aan de index pagina (\'[Meer statistieken]\').';
...
$txt['permissionhelp_who_view'] = '\'Gebruikers online\' toont alle leden die online zijn en wat ze aan het doen zijn op dat moment. Deze permissie zal alleen werken als dit is geactiveerd in \'Features en Opties\'. Je kunt de lijst bekijken door te klikken op de link in de \'Gebruikers Online\' sectie in de board index.';
$txt['permissionname_search_posts'] = 'Zoeken naar berichten en topics';
$txt['permissionhelp_search_posts'] = 'De zoek permissie staat gebruikers toe alle boards waar zij toegang toe hebben af te zoeken. Als deze permissie is geactiveerd, zal een \'Zoek\' knop worden toegevoegd aan de knoppenbalk.';
$txt['permissionname_karma_edit'] = 'Karma van andere leden aanpassen';
$txt['permissionhelp_karma_edit'] = 'Karma is een feature die de populariteit van een lid toont. Om deze feature te kunnen gebruiken, dient dit te zijn geactiveerd in \'Features en Opties\'. Deze permissie zal leden de mogelijkheid geven een stem uit te bregen. Gasten kunnen dat niet.';

$txt['permissiongroup_pm'] = 'Persoonlijke Berichten';
$txt['permissionname_pm_read'] = 'Lees Persoonlijke Berichten';
$txt['permissionhelp_pm_read'] = 'Deze permissie staat leden toe om toegang te krijgen tot de Persoonlijke Berichten sectie en Persoonlijke Berichten te ontvangen. Zonder deze permissie kan een gebruiker geen persoonlijke berichten versturen.';
$txt['permissionname_pm_send'] = 'Stuur Persoonlijk Berichten';
$txt['permissionhelp_pm_send'] = 'Stuur Persoonlijk Berichten naar andere leden. Vereist dat de \'Lees Persoonlijke Berichten\' permissie aan staat.';

$txt['permissiongroup_calendar'] = 'Kalender';
$txt['permissionname_calendar_view'] = 'Bekijk de kalender';
$txt['permissionhelp_calendar_view'] = 'De kalender toont voor iedere maand de verjaardagen, gebeurtenissen en feestdagen. Met deze permissie krijgt de gebruiker toegang tot de kalender. Als deze permissie is geactiveerd, verschijnt er een knop in de knoppenbalk en zal er een lijst verschijnen onderaan de forumindexpagina met daarop de huidige en aankomende verjaardagen, gebeurtenissen en feestdagen. De kalender dient dan wel te zijn geaktiveerd in \'Features en Opties\'.';
...
$txt['permissionhelp_admin_forum'] = 'Deze permissie geeft de gebruiker de mogelijkheid om:<ul><li>de forum, database en de thema-instellingen te veranderen</li><li>packages te beheren</li><li>gebruik te maken van forum- en database-onderhoudstools</li><li>het bekijken van fouten- en moderatie-log bestanden</li></ul>Wees voorzichtig met deze permissie, daar deze erg krachtig is.';
...
$txt['permissionhelp_manage_attachments'] = 'Deze permissie verschaft toegang tot de bestandsmanagers waar alle bijlagen en avatars op een rijtje staan en kunnen worden verwijderd.';
$txt['permissionname_manage_smileys'] = 'Beheer smileys';
$txt['permissionhelp_manage_smileys'] = 'Hiermee kun je toegang krijgen tot het smiley beheer. In het smileybeheer kun je smileys en smiley sets toevoegen, bewerken en verwijderen.';
$txt['permissionname_edit_news'] = 'Bewerk nieuws';
$txt['permissionhelp_edit_news'] = 'De nieuws functie toont willekeurig een nieuwsregel op elk scherm. Om dit te tonen dient dit geactiveerd te zijn in de foruminstellingen.';
...
$txt['permissionname_moderate_forum'] = 'Beheer forum leden';
$txt['permissionhelp_moderate_forum'] = 'Deze permissie behelst alle belangrijke functies voor ledenbeheer:<ul><li>toegang tot registratiebeheer</li><li>toegang tot bekijk/verwijder leden scherm</li><li>uitgebreide profielinformatie, inclusief traceer IP/gebruiker en (verborgen) online status</li><li>activeer accounts</li><li>ontvang leden goedkeuringsnotificaties en keur accounts goed</li><li>immuun voor negeer PM</li><li>verscheidene kleine zaken</li></ul>';
...
$txt['permissionname_profile_identity'] = 'Bewerk account instellingen';
$txt['permissionhelp_profile_identity'] = 'Account instellingen zijn de basis instellingen van een profiel, zoals wachtwoord, e-mailadres, ledengroep en voorkeurs taal.';
$txt['permissionname_profile_identity_own'] = 'Eigen profiel';
$txt['permissionname_profile_identity_any'] = 'Elk profiel';
$txt['permissionname_profile_extra'] = 'Bewerk extra profiel instellingen';
$txt['permissionhelp_profile_extra'] = 'Extra profiel instellingen bevatten instellingen voor avatars, thema voorkeuren, notificaties en persoonlijke berichten.';
...
$txt['permissionhelp_profile_upload_avatar'] = 'Deze permissie zorgt ervoor dat een gebruiker z\'n persoonlijke avatar kan uploaden naar de server.';
$txt['permissionname_profile_remote_avatar'] = 'Kies een elders opgeslagen avatar';
$txt['permissionhelp_profile_remote_avatar'] = 'Omdat avatars de laadtijd van een pagina negatief kunnen be&iuml;nvloeden, is het mogelijk om bepaalde ledengroepen niet toe te staan avatars van andere lokaties te laten gebruiken.';

$txt['permissiongroup_general_board'] = 'Algemeen';
$txt['permissionname_moderate_board'] = 'Modereer board';
$txt['permissionhelp_moderate_board'] = 'De modereer board permissie voegt een paar permissies toe, zodat een moderator ook een echte moderator wordt. Permissies bevatten het reageren op reeds gelockte topics, het veranderen van de verloopdatum van een poll en het bekijken van de resultaten van een poll.';
...
$txt['permissionhelp_send_topic'] = 'Deze permissie stelt een gebruiker in staat om een topic naar een vriend te mailen door zijn e-mailadres in te vullen en een berichtje er aan toe te voegen.';
$txt['permissionname_make_sticky'] = 'Maak topics sticky';
$txt['permissionhelp_make_sticky'] = 'Sticky topics zijn topics die altijd bovenaan de lijst met topics op een board blijven staan. Ze kunnen handig zijn voor aankondigingen of andere belangrijke berichten.';
...
$txt['permissionhelp_report_any'] = 'Deze permissie voegt een link toe aan ieder bericht die de gebruiker het bericht kan laten rapporteren aan de moderators. Alle moderators van dat board zullen dan een e-mail krijgen met een omschrijving erbij (zoals deze door de gebruiker is ingevuld).';
...
$txt['permissionhelp_poll_vote'] = 'Deze permissie stelt een (geregistreerd) lid in staat een stem uit te brengen. Heeft geen invloed op gasten.';
...
$txt['permissionhelp_poll_add'] = 'Deze permissie stelt een gebruiker in staat om een poll toe te voegen aan een reeds bestaande topic. Je hebt dan wel voldoende rechten nodig om het eerste bericht in een topic te mogen bewerken.';
...
$txt['permissionhelp_poll_edit'] = 'Deze permissie stelt een gebruiker in staat de opties van een poll te bewerken en een poll te resetten. Om het maximum aantal stemmen en de verloop datum te kunnen veranderen heeft de gebruiker de \'Modereer board\' permissie nodig.';
...
$txt['permissionhelp_mark_any_notify'] = 'Deze permissie stelt een gebruiker in staat om een notificatie bericht (e-mail) te krijgen wanneer er een reactie is in een topic waar hij dit heeft aangevraagd.';
$txt['permissionname_mark_notify'] = 'Verzoek notificatie bij nieuwe topics';
$txt['permissionhelp_mark_notify'] = 'Deze permissie stelt een gebruiker in staat om een notificatie bericht (e-mail) te krijgen wanneer er een topic is gestart in een board waar hij dit heeft aangevraagd.';

$txt['permissiongroup_attachment'] = 'Bijlagen';
$txt['permissionname_view_attachments'] = 'Bekijk bijlagen';
$txt['permissionhelp_view_attachments'] = 'Bijlagen (attachments) zijn bestanden die als bijlage zijn geplaatst in berichten. Deze feature kan worden geactiveerd en beheerd in \'Features en opties\'. Omdat bijlagen niet direct worden benaderd, kun je ze beschermen tegen downloaden door gebruikers die deze rechten niet hebben.';
