...
$txt['manual_pm_delete_selected'] = 'Remove Selected';
$txt['manual_pm_pages'] = 'Pages';
$txt['manual_pm_nav_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top in a stacked diagonal mode.';
$txt['manual_pm_delete_button'] = 'The main <strong>Remove selected</strong> button and the checkboxes allow you to delete selected messages, with the top checkbox selecting all.';
$txt['manual_pm_outbox_button'] = 'The <strong>Outbox</strong> link toggles to your outbox, where it it will be highlighted like the <strong>Inbox</strong> link is here.';
...
$txt['manual_pm_reload'] = 'The <strong>Change view</strong> icon alters the layout of messages on the page.';
