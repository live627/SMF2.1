...
$helptxt['spider_group'] = 'By assigning a spider to a group, when a guest is detected as a search crawler it will automatically be assigned the selected group in addition to that of a guest. You can use this to provide greater or lesser access to a search engine than you would a normal guest. You might for example wish to create a new group called &quot;Spiders&quot; and select that here. You could then deny permission for that group to view profiles to stop spiders indexing your members profiles.<br />Note: Spider detection is not perfect and can be simulated by users so this feature is not guaranteed to restrict content only to those search engines you have added.';
