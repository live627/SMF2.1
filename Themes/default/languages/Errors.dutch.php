...
$txt['mods_only'] = 'Alleen beheerders en administrators mogen direct berichten verwijderen.';
...
$txt['no_password'] = 'Wachtwoord veld was leeg';
...
$txt['members_only'] = 'Alleen voor leden...';
...
$txt['didnt_select_vote'] = 'Je hebt geen optie gekozen.';
...
$txt['locked_by_admin'] = 'Dit is vergrendeld door een beheerder.  Je kunt deze niet ontgrendelen.';
$txt['not_enough_posts_karma'] = 'Sorry, je hebt nog niet voldoende berichten gepost om Karma te kunnen bewerken - je hebt tenminste %1$d.';
$txt['cant_change_own_karma'] = 'Sorry, je kunt niet je eigen Karma bewerken.';
$txt['karma_wait_time'] = 'Sorry, je kunt deze actie niet zo snel achter elkaar uitvoeren.  Je zult even moeten wachten %1$s %2$s.';
...
$txt['file_too_big'] = 'Het bestand is te groot. Het maximumformaat is %d KB.';
$txt['attach_timeout'] = 'Er is iets foutgegaan bij het wegschrijven van je bijlage, probeer het alsjeblieft nog eens.';
$txt['filename_exisits'] = 'Sorry! Deze bestandsnaam is reeds aanwezig in de directory. Gebruik een andere naam, en probeer het nog eens.';
...
$txt['topic_one_post'] = 'Het topic bestaat uit &eacute;&eacute;n bericht, en kan dus niet worden gesplitst.';
$txt['no_posts_selected'] = 'Geen berichten geselecteerd ';
$txt['slected_all_posts'] = 'Splitsen onmogelijk, je hebt alle berichten geselecteerd.';
...
$txt['session_varify_fail'] = 'Sessie-check fout. Probeer het nog een keer.';
$txt['verify_url_fail'] = 'Ongeldige refererende site.';
...
$txt['no_theme'] = 'Dat thema bestaat niet.';
