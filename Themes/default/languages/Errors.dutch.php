...
$txt[75] = 'Je hebt je naam niet ingevuld, dit is echter een vereiste';
$txt[76] = 'Je hebt je e-mailadres niet ingevuld, dit is echter een vereiste';
$txt[90] = 'Dit topic is gesloten, je mag geen berichten meer plaatsen of wijzigen...';
$txt[91] = 'Wachtwoord veld was leeg';
$txt[93] = 'Jij mag dit topic niet sluiten of heropenen';
...
$txt['smf126'] = 'De uploadmap zit vol. Probeer een kleiner bestand te uploaden en/of stel de beheerder op de hoogte.';
$txt['smf191'] = 'De server of het bestand dat je opgaf kon niet gevonden worden.';
$txt['smf232'] = 'Het board dat je opgaf bestaat niet';
$txt['smf253'] = 'Het is je niet toegestaan om topics te splitsen';
$txt['smf262'] = 'Het is je niet toegestaan om topics samen te voegen';
$txt['smf263'] = 'Ongeldig topic-ID gespecificeerd.';
$txt['smf268'] = 'Je kunt een topic niet bij het eerste bericht afsplitsen';
$txt['smf270'] = 'Het topic bestaat uit &eacute;&eacute;n bericht, en kan dus niet worden gesplitst.';
$txt['smf271'] = 'Geen berichten geselecteerd ';
$txt['smf271b'] = 'Splitsen onmogelijk, je hebt alle berichten geselecteerd.';
$txt['smf272'] = 'Geen berichten gevonden.';
$txt['smf273'] = 'Het is niet mogelijk om een topic in te voegen';
$txt['smf289'] = 'Je hebt een gebruikersnaam gekozen van een bestaande moderator. Kies een andere gebruikersnaam';
$txt['smf304'] = 'Fout bij het versturen van het formulier. Sessie timeout.';
$txt['smf305'] = 'Sessie-check fout. Probeer het nog een keer.';
$txt['smf306'] = 'Ongeldige refererende site.';
...
$txt['cannot_remove_any'] = 'Sorry, je hebt geen rechten om een topic te verwijderen.';
$txt['cannot_remove_own'] = 'Je kan je eigen bijdragen op dit board niet verwijderen.';
...
$txt['cannot_manage_smileys'] = 'Je mag geen smileys beheren';
...
$txt['cannot_profile_title_any'] = 'Je mag niet iemands titels aanpassen.';
...
$txt['theme3'] = 'Dat thema bestaat niet.';
...
$txt['delFirstPost'] = 'Je mag het eerste bericht niet verwijderen.<p>Dit kan alleen door de hele topic te verwijderen, of het aan een admin te vragen.</p>';
...
$txt['pswd7'] = 'Sorry, maar je hebt een verkeerd antwoord gegeven.  Klik op de terug knop om het nog eens te proberen, of klik 2 keer op de terug knop om de standaard methode toe te passen.';
$txt['rtm11'] = 'Geen moderators gevonden !';
...
$txt['calendar1'] = 'Foutieve maand-waarde.';
$txt['calendar2'] = 'Foutieve jaar-waarde.';
$txt['calendar7'] = 'De maand voor de gebeurtenis ontbreekt.';
$txt['calendar8'] = 'Het jaar voor de gebeurtenis ontbreekt.';
$txt['calendar14'] = 'De dag voor de gebeurtenis ontbreekt.';
$txt['calendar15'] = 'De titel voor de gebeurtenis ontbreekt.';
$txt['calendar16'] = 'Foutieve datum.';
$txt['calendar17'] = 'Er is geen titel opgegeven.';
$txt['calendar18'] = 'Het ID ontbreekt.';
$txt['calendar19'] = 'Het is jou niet toegestaan deze gebeurtenis te bewerken.';
$txt['calendar38'] = 'Board ID ontbreekt.';
$txt['calendar39'] = 'Topic ID ontbreekt.';
$txt['calendar40'] = 'Topic bestaat niet.';
$txt['calendar41'] = 'Je bent niet de eigenaar van deze topic.';
$txt['calendar42'] = 'Dit board bestaat niet.';
$txt['calendar55'] = 'Er is momenteel geen maximum ingesteld.';
$txt['calendar56'] = 'Ongeldig aantal dagen ingegeven.';
...
$txt['no_ban_admin'] = 'Je mag geen admin bannen, je dient deze dan eerst een lagere functie te geven!';
...
$txt['spamWaitTime_broken'] = 'Het laatste bericht van je was minder dan %d seconden geleden! Probeer het later nogmaals!';

$txt['registerWaitTime_broken'] = 'Je bent al geregistreerd, %d seconden geleden!';
$txt['loginWaitTime_broken'] = 'Je zal %d seconden moeten wachten om opnieuw in te loggen, sorry.';
...
$txt['attachments_limit_per_post'] = 'Je mag niet meer dan %d bijlagen per bericht uploaden';

$txt['rtm_not_own'] = 'Je kunt niet je eigen bericht melden aan de moderators, dat heeft geen zin!';
...
$txt['error_long_message'] = 'Het bericht overschrijdt de maximum toegstane lengte (%1$d karakters).';
...
$txt['packageget_unable'] = 'Kan geen verbinding krijgen met de server.  Probeer in plaats daarvoor <a href="%s" target="_blank">deze URL</a> te gebruiken.';
$txt['not_on_simplemachines'] = 'Sorry, packages kunnen op deze manier alleen worden gedownload vanaf de simplemachines.org server.';
...
$txt['profile_error_bad_avatar'] = 'De avatar die je hebt geselecteerd is te groot';
...
$txt['name_censored'] = 'De naam die je probeert te gebruiken, %s, bevat helaas woorden die gecensureerd zijn. Probeer een andere naam.';
