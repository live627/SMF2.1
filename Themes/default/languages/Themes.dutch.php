...
$txt['user_avatars'] = 'Mag het lid z\'n foto laten zien in de berichten?';
$txt['user_text'] = 'Mag het lid z\'n tekst laten zien in de berichten?';
$txt['gender_images'] = 'Wil je het man/vrouw symbool weergeven onder de gebruikersnaam?';
$txt['news_fader'] = 'Laat de nieuws balk zien?';
$txt['member_list_bar'] = 'Laat de ledenlijst zien in de BoardIndex?';
$txt['current_pos_text_img'] = 'Laat de huidige positie zien in het forum als link in plaats van tekst';
$txt['show_view_profile_button'] = 'Laat de profiel knop zien onder ieder bericht';
$txt['enable_mark_as_read'] = 'Laat  de \'Alles gelezen\' knoppen zien?';
