...
$txt['pruneModLog'] = 'Remove moderation log entries older then (in days) - 0 to disable';
$txt['pruneBanLog'] = 'Remove ban hit log entries older then (in days) - 0 to disable';
$txt['pruneReportLog'] = 'Remove report to moderator log entries older then (in days) - 0 to disable';
$txt['pruneScheduledTaskLog'] = 'Remove scheduled task log entries older then (in days) - 0 to disable';
