...
$txt['pruneErrorLog'] = 'Remove error log entries older than (in days) - 0 to disable';
$txt['pruneModLog'] = 'Remove moderation log entries older than (in days) - 0 to disable';
$txt['pruneBanLog'] = 'Remove ban hit log entries older than (in days) - 0 to disable';
$txt['pruneReportLog'] = 'Remove report to moderator log entries older than (in days) - 0 to disable';
$txt['pruneScheduledTaskLog'] = 'Remove scheduled task log entries older than (in days) - 0 to disable';
...
$txt['languages_for_pspell'] = 'This is for <a href="http://www.php.net/function.pspell-new" class="extern">pSpell</a> - if installed';
