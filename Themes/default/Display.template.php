...
<div id="forumposts" class="tborder">
	...
	while ($message = $context['get_message']())
	{
		...
		if ($ignoring)
			echo '<div id="msg_', $message['id'], '_ignored_prompt">', $txt['ignoring_user'], ' <a href="#" id="msg_', $message['id'], '_ignored_link" style="display: none;">', $txt['show_ignore_user_post'], '</a></div>';
