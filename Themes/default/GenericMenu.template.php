...
function template_generic_menu_sidebar_above()
{
	...
	foreach ($menu_context['sections'] as $section)
	{
		...
		if ($firstSection && !empty($menu_context['can_toggle_drop_down']))
			echo '
						<a href="', $scripturl, '?action=', $menu_context['current_action'], ';area=', $menu_context['current_area'], ';sa=', $menu_context['current_section'], ';sc=', $context['session_id'], ';togglebar=0"><img style="margin: 0 0 0 5px;" src="' , $context['menu_image_path'], '/change_menu2.png" alt="!" class="png_fix" /></a>';
		echo '
						</td>
					</tr>
					<tr class="windowbg2">
		...
		<table cellpadding="0" cellspacing="0" id="menu_toggle">
			<tr>
				...
				<td class="mirrortab_back">
					<a href="', $scripturl, '?action=', $menu_context['current_action'], ';area=', $menu_context['current_area'], ';sa=', $menu_context['current_section'], ';sc=', $context['session_id'], ';togglebar=1"><img style="margin: 0 2px 0 2px;" src="' , $context['menu_image_path'], '/change_menu.png" alt="*" class="png_fix" /><span>!</span></a>
				</td>
