		...
		echo '
						...
						<fieldset id="poll_options">
							...
							<dl class="settings poll_options">
								...
								<dd>
									<input type="text" name="poll_expire" id="poll_expire" size="2" value="', !empty(Utils::$context['poll_options']['expire']) ? Utils::$context['poll_options']['expire'] : '', '" maxlength="4"> ', Lang::$txt['days_word'], '
								</dd>
								<dt>
