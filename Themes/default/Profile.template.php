...
function template_forumProfile()
{
	...
	if ($context['signature_enabled'])
	{
		...
		if (!empty($context['signature_limits']['max_length']))
			echo '
									<span class="smalltext">', sprintf($txt[664], $context['signature_limits']['max_length']), ' <span id="signatureLeft">', $context['signature_limits']['max_length'], '</span></span><br />';
...
function template_pmprefs()
{
	...
	echo '
									...
									<label for="pm_remove_inbox_label" id="pm_remove_inbox_label"><input type="checkbox" name="default_options[pm_remove_inbox_label]" value="1"', !empty($context['member']['options']['pm_remove_inbox_label']) ? ' checked="checked"' : '', ' class="check" /> ', $txt['pm_remove_inbox_label'], '</label><br />
								</td>
							</tr>';
