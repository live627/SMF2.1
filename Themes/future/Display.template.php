...
<div class="clearfix margintop" id="postbuttons">
	...
	<div class="nav floatright">', template_buttonlist($normal_buttons, false), '</div>
</div>';
...
<div id="forumposts" class="tborder">
	...
	while ($message = $context['get_message']())
	{
		...
		if (!$message['member']['is_guest'])
		{
			...
			if ($message['member']['karma']['allow'])
				echo '
							<li>	
								<a href="', $scripturl, '?action=modifykarma;sa=applaud;uid=', $message['member']['id'], ';topic=', $context['current_topi		c'], '.' . $context['start'], ';m=', $message['id'], ';sesc=', $context['session_id'], '">', $modSettings['karmaApplaudLabel'], '</a>
		...
		echo '
				...
				<div class="postarea">
					<div class="keyinfo">
						...
						<h5 id="subject_', $message['id'], '"><a href="', $message['href'], '">', $message['subject'], '</a></h5>
	...
	<div class="clearfix marginbottom" id="postbuttons_lower">
		...
		<div class="nav floatright">', template_buttonlist($normal_buttons, true), '	</div>
	...
	echo '
	<div id="moderationbuttons">', 	template_buttonlist($mod_buttons, false), '</div>';
