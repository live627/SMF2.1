...
function template_main()
{
	...
	echo '
	<h4 class="titlebg mlist"><span class="left"></span><span class="right"></span>
			<span class="mlist_title">', $txt['members_list'], '</span>';
	if (!isset($context['old_search']))
			echo '	
			<span class="mlist_letter">', $context['letter_links'], '</span>';
	echo '
	</h4>';
			...
			<div id="memberlist_search">
				...
				<div class="roundframe"><div class="innerframe">
					<div id="mlist_search">
						...
						<span class="mlist_search_options">';
