...
function template_new_group()
{
	...
	echo '
								<br />
								<input type="checkbox" id="checkall_check" class="check" onclick="invertAll(this, this.form, \'boardaccess\');" /> <label for="checkall_check"><em>', $txt['check_all'], '</em></label>
							</fieldset>
						</dd>		
					</dl>
...
function template_group_members()
{
	...
	if (!empty($context['group']['assignable']))
		echo '
				<div class="align_right"><input type="submit" name="remove" value="', $txt['membergroups_members_remove'], '" style="font-weight: normal;" /></div>';			
	echo '		
			</div>
			<br />';
