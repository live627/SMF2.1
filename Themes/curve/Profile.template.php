		...
		<div class="tborder add_buddy">
			...
			<div class="roundframe">
				<div class="innerframe">
					...
					<div><input type="submit" value="', $txt['buddy_add_button'], '" class="button_submit" /></div>
				</div>
			</div>
