...
function template_edit_profile_field()
{
	...
	{
		echo '
					', $k == 0 ? '' : '<br />', '<input type="radio" name="default_select" value="', $k, '"', $context['field']['default_select'] == substr(md5($option), 0, 8) ? ' checked="checked"' : '', ' /><input type="text" name="select_option[', $k, ']" value="', $option, '" />';
	}
	echo '
					<span id="addopt"></span>
