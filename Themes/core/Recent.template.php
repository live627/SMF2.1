...
function template_main()
{
	...
	foreach ($context['posts'] as $post)
	{
		...
		{
			echo '
			<div class="modbuttons clearfix" id="modbuttons_bottom">';
...
function template_unread()
{
	...
	echo '
			...
			<div id="readbuttons" class="modbuttons clearfix">
				<div class="floatleft middletext">', $txt['pages'], ': ', $context['page_index'], '</div>';
	...
	echo '
		<div class="clearfix description" id="topic_icons">
...
function template_replies()
{
	...
	echo '
			...
			<div id="modbottoms_bottom" class="modbuttons clearfix">
				<div class="floatleft middletext">', $txt['pages'], ': ', $context['page_index'], '</div>';
