...
if (typeof(window.smfVersion) != "undefined" && window.smfVersion == "SMF 1.0")
	...
	window.smfLatestPackages = 'A security issue has been identified in SMF 1.0.7.  You can install <a href="' + window.smfForum_scripturl + '?action=pgdownload;auto;package=http://custom.simplemachines.org/mods/downloads/smf_1-0-8_package.tar.gz;sesc=' + window.smfForum_sessionid + '">this patch (click here to install)</a> to easily update yourself to the latest version.<br /><br />If you have any problems applying it, you can use the version posted on the downloads page - although, any modifications you have installed will need to be uninstalled.  Please post on the <a href="http://www.simplemachines.org/community/index.php">forum</a> if you need more help.';
	...
	window.smfLatestPackages = 'A bug in PHP causes a vulnerability in SMF 1.1 RC2-1. You can install <a href="' + window.smfForum_scripturl + '?action=pgdownload;auto;package=http://custom.simplemachines.org/mods/downloads/smf_1-1-rc2-2_package.tar.gz;sesc=' + window.smfForum_sessionid + '">this patch (click here to install)</a> to patch your version of 1.1 RC2 to 1.1 RC2-2.<br /><br />If you have any problems applying it, you can use the version posted on the downloads page - although, any modifications you have installed will need to be uninstalled.  Please post on the <a href="http://www.simplemachines.org/community/index.php">forum</a> if you need more help.';
else if (typeof(window.smfVersion) != "undefined" && window.smfVersion == "SMF 1.1")
	window.smfLatestPackages = 'A number of small bugs and a security issue have been identified in SMF 1.1 Final. You can install <a href="' + window.smfForum_scripturl + '?action=pgdownload;auto;package=http://custom.simplemachines.org/mods/downloads/smf_1-1-1_patch.tar.gz;sesc=' + window.smfForum_sessionid + '">this patch (click here to install)</a> to update your version of SMF to 1.1.1.<br /><br />If you have any problems applying it, you can use the version posted on the downloads page - although, any modifications you have installed will need to be uninstalled.  Please post on the <a href="http://www.simplemachines.org/community/index.php">forum</a> if you need more help.';
else if (typeof(window.smfVersion) != "undefined" && window.smfVersion == "SMF 1.1.1")
	window.smfLatestPackages = 'A number of bugs and a couple of low risk security issues have been identified in SMF 1.1.1 - and some improvements have been made to the visual verification images on registration. You can install <a href="' + window.smfForum_scripturl + '?action=pgdownload;auto;package=http://custom.simplemachines.org/mods/downloads/smf_1-1-2_patch.tar.gz;sesc=' + window.smfForum_sessionid + '">this patch (click here to install)</a> to update your version of SMF to 1.1.2.<br /><br />If you have any problems applying it, you can use the version posted on the downloads page - although, any modifications you have installed will need to be uninstalled.  Please post on the <a href="http://www.simplemachines.org/community/index.php">forum</a> if you need more help.';
