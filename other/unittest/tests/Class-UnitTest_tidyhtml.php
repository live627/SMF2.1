		...
		public function __construct()
		{
			...
			$this->_tests = array(
				...
				'Profile_1' => array(
					...
					'url' => $scripturl . '?action=profile;sa=summary',
				),
				'Profile_2' => array(
					'name' => 'Profile (2)',
					'description' => "Show stats",
					'url' => $scripturl . '?action=profile;sa=statPanel',
				),
				'Profile_3' => array(
					'name' => 'Profile (3)',
					'description' => "Show posts",
					'url' => $scripturl . '?action=profile;sa=showPosts',
				),
				'Profile_4' => array(
					'name' => 'Profile (4)',
					'description' => "Show topics",
					'url' => $scripturl . '?action=profile;sa=showPosts;topics',
				),
				'Profile_5' => array(
					'name' => 'Profile (5)',
					'description' => "Show attachments",
					'url' => $scripturl . '?action=profile;sa=showPosts;attach',
				),
				'Profile_6' => array(
					'name' => 'Profile (6)',
					'description' => "Show permissions",
					'url' => $scripturl . '?action=profile;sa=showPermissions',
				),
				'Profile_7' => array(
					'name' => 'Profile (7)',
					'description' => "Track user",
					'url' => $scripturl . '?action=profile;sa=tracking;area=user',
				),
				'Profile_8' => array(
					'name' => 'Profile (8)',
					'description' => "Track IP",
					'url' => $scripturl . '?action=profile;sa=tracking;area=ip',
				),
				'Profile_9' => array(
					'name' => 'Profile (9)',
				...
				'Profile_10' => array(
					...
					'url' => $scripturl . '?action=profile;sa=account',
				),
				'Profile_11' => array(
					'name' => 'Profile (11)',
					'description' => "Profile settings",
					'url' => $scripturl . '?action=profile;sa=forumProfile',
				),
				'Profile_12' => array(
					'name' => 'Profile (12)',
					'description' => "Theme settings",
					'url' => $scripturl . '?action=profile;sa=theme',
				),
				'Profile_13' => array(
					'name' => 'Profile (13)',
					'description' => "Notification settings",
					'url' => $scripturl . '?action=profile;sa=notification',
				),
				'Profile_14' => array(
					'name' => 'Profile (14)',
					'description' => "Personal message preferences",
					'url' => $scripturl . '?action=profile;sa=pmprefs',
				),
				'Profile_15' => array(
					'name' => 'Profile (15)',
					'description' => "Ignore boards",
					'url' => $scripturl . '?action=profile;sa=ignoreboards',
				),
				'Profile_16' => array(
					'name' => 'Profile (16)',
					'description' => "Edit buddies",
					'url' => $scripturl . '?action=profile;sa=editBuddies',
				),
				'Profile_17' => array(
					'name' => 'Profile (17)',
					'description' => "Subscriptions",
					'url' => $scripturl . '?action=profile;sa=subscriptions',
				),
				'Profile_18' => array(
					'name' => 'Profile (18)',
					'description' => "Delete account",
					'url' => $scripturl . '?action=profile;sa=deleteAccount',
				),
				'Recent_1' => array(
					'name' => 'Recent posts (1)',
