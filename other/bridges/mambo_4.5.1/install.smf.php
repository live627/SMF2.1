...
function com_install() 
{
	...
	$database->setQuery("
		...
		VALUES ('', 'Simple Machines Forum Registration', 'option=com_smf_registration', 0, 0, 'option=com_smf&task=config', 'Simple Machines Forum Registration', 'com_smf_registration', 0, 'js/ThemeOffice/component.png', 0, '')");
	$result[1] = $database->query();

	rename($mosConfig_absolute_path . '/administrator/components/com_smf/modules/mod_smf_login.php', $mosConfig_absolute_path . '/modules/mod_smf_login.php');
	rename($mosConfig_absolute_path . '/administrator/components/com_smf/modules/mod_smf_login.x', $mosConfig_absolute_path . '/modules/mod_smf_login.xml');
	...
	if ($_VERSION->PRODUCT == 'Joomla!'){
		@chmod ($mosConfig_absolute_path . '/mambots/system', 0777 );
		rename($mosConfig_absolute_path . '/administrator/components/com_smf/bots/SMF_header_include.php', $mosConfig_absolute_path . '/mambots/system/SMF_header_include.php');
		rename($mosConfig_absolute_path . '/administrator/components/com_smf/bots/SMF_header_include.x', $mosConfig_absolute_path . '/mambots/system/SMF_header_include.xml');
	
		$database->setQuery("
			INSERT INTO #__mambots 
