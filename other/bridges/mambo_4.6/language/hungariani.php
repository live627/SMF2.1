<?php
/**
* @version $Id: hungariani.php,v 1.2 2006-09-16 16:11:35 orstio Exp $
* @package smf-bridge
...
class smfbLanguage
{
	...
	var $SMBF_A_CONF_PATH_TT = 'Itt adhatod meg az SMF telepítésének ABSZOLÚT ÚTVONALÁT. TANÁCS: ha bizonytalan vagy, akkor nyomd meg * Az útvonal automatikus létrehozása * gombot';
	var $SMBF_A_CONF_DB_SMF_NAME_TT = 'Annak az adatbázisnak a neve, melybe telepítetted az SMF fórumot.  Hagyd üresen, ha a Mambo/Joomla! és az SMF telepítése ugyanabba az adatbázisba történt';
	var $SMBF_A_CONF_DB_SMF_PREFIX_TT = 'Az SMF adatbázis elõtagja, normál esetben * smf_ *';
	var $SMBF_A_CONF_DB_MOS_PREFIX_TT = 'Az SMF adatbázis elõtagja, normál esetben * mos_ *, FIGYELEM! Az elõtagnak ugyanannak kell lennie, mint amit a Mambo/Joomla! telepítésben megadtál! TANÁCS: Ha bizonytalan vagy, akkor kattints * A Mambo DB elõtag hozzáadása * gombra';
	var $SMFB_A_CONF_MOS_PREFIX_BUTTON = 'A Mambo DB elõtag hozzáadása';
	var $SMBF_A_CONF_WRAPPED_TITLE_TT = 'Ez - lehet - itt az egyik legfontosabb beállítás! Itt kell meghatároznod, hogy az SMF beépüljön-e (beágyazásra kerüljön) a Mamboba, vagy ne (beágyazatlan legyen). Ettõl a beállítástól függõen néhány olyan további beállítást kell megadnod, melyekrõl a * readme* fájlban olvashatsz';
