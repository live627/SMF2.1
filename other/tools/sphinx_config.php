...
function step_1()
{
	...
	echo '
	<p>
		This tool will assume you will be installing Sphinx version ', $sphinx_ver, '. A newer version might be available and, if so, would probably be better. Just understand that the steps below and the working of the search engine might be different in future versions of Sphinx. Please not that Sphinx versions prior to 0.9.8 will not work properly.
	</p>
